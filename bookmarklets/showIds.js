javascript: (function () {
  ...
  $("div.user").find("a:first").each(function () {
  ...
  $("body#call h1").eq(0).each(function () {
    $(this).append("<span style='color:blue;padding-left:10px;font-size:12px'>company: " + data.call.companyId + " owner: " + data.owner.appUserID + "</span>");
  });
})()
