...
// @downloadURL https://honeyfy.github.io/public_research/bookmarklets/Emails_Labeler_Firebase.js
// ==/UserScript==
...
function addButtons(){
    var buttons = $("<div style='display: flex; justify-content: flex-end; margin: 0; padding: 0;'>"+
                    "<a href='javascript:editLabels();' class='btn btn-link nav-link'><span style='color:darkgreen'>EDIT</span></a>"+
